		...
		<div class="modal-content">
			...
			<div class="modal-body mx-3">
				<form action="updateUser" method="post">
					...
					<input type="text" id="userName" name="userName" value=<% String uname= request.getAttribute("uname").toString(); out.print(uname); %>> 
					<input type="hidden" name="id_" value=<% int id_= (int)request.getAttribute("id_"); out.print(id_); %>> <label
						for="mobileNumber">MobileNumber</label> <input type="text"
						id="mobileNumber" name="mobileNumber"
						value=<% String mn= request.getAttribute("mn").toString(); out.print(mn); %>> <label for="email">Email</label>
					<input type="email" id="email" name="email"
						value=<% String em= request.getAttribute("em").toString(); out.print(em); %>> <label for="password">Password</label>
