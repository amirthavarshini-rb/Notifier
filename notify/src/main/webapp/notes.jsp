	...
	<div class="modal fade" id="myModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
					...
					<form action="insertNote" method="post" onsubmit="return validateNoteForm()">
...
<!--  "<c:url value='showNoteDetails/${note.getId()}.do'/>"-->
			<h3><a  id="dailyTask" href="showNote"> <% String nname= (String)(request.getAttribute("nname")); out.print(nname); %>
										</a></h3>
			<p>StartDate :<% String date= (String)(request.getAttribute("sdate")); out.print(date); %></p>
			<p>EndDate   :<% String enddate= (String)(request.getAttribute("edate")); out.print(enddate); %> </p>
		...
		<% i=i+1; %>
			<tr>
				...
				<div name="myTable">
							...
							<div class="panel panel-default contain">
								<div class="panel-body">
									<div class="row">
										...
										<!-- "<c:url value='showNoteDetails/${item.getId()}.do'/>"  -->
											<a  id="notedetails" href="showNote"> <% String nname= (String)(request.getAttribute("nname")); out.print(nname); %>
										</a>
												
												
										</div>
										<div class="col-md-2 text-left">Started on: <% String date= (String)(request.getAttribute("sdate")); out.print(date); %></div>
                    ...
                    <div class="panel-body">
                    <% String des= (String)(request.getAttribute("des")); out.print(des);%>
                     </div>
